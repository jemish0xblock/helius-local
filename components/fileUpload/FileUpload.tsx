...
const FileUpload: React.FC<jobPostFile> = ({ deleteFileUpload, fileUpload, setFileUpload }) => {
  ...
  const props: UploadProps = {
    beforeUpload: (file) => {
      ...
      return (isLt25M && fileLength && checkFileNameDuplicate) || Upload.LIST_IGNORE;
    },
      ...
      <Form.Item name="fileUploadForm" valuePropName="file" getValueFromEvent={normFile}>
        ...
        >
          <div key={uploadKey}>
            ...
            <div style={{ fontSize: "14px" }}>Max 3 file allow, 25 MB limit.</div>
          </div>
        </Upload>
      </Form.Item>
    </div>
