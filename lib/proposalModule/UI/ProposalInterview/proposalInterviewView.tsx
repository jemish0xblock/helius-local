...
import { calenderIcon, clockIcon2, clockSmallIcon, expertIcon, referFreelancer } from "@/utils/allSvgs";
...
import s from "./proposalInterview.module.less";

const { Title } = Typography;

interface IProposalInterviewScreen {
...
const ProposalInterview: React.FC<IProposalInterviewScreen> = ({
  allProposalDetails,
  proposalFetchingRecord,
  declinedModelStateData,
  pageTitle,
          ...
          <Row gutter={30}>
            <Col span={18}>
              ...
              <div className={s.h_card_wrapper}>
                <Card
                  className={s.h_card_main}
                  title={<div className={s.h_card_header}>Activity on this job</div>}
                  bordered
                >
                  <Spin spinning={proposalFetchingRecord?.isFetchingProposalDetails}>
                    <div className={s.h_card_content_main}>
              ...
              <div className={s.h_card_wrapper}>
                <Card
                  className={s.h_card_main}
                  title={<div className={s.h_card_header}>Original message from client</div>}
                  bordered
                >
                  <Spin spinning={proposalFetchingRecord?.isFetchingProposalDetails}>
                    <div className={s.h_card_content_main}>
